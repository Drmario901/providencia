...
function generateForm($data, $logoBase64, $exitHour, $nombre, $productos, $tara, $destination, $observations) {
    return '
    <div class="form-container">
        ...
        <div class="section">
            <div class="left">
                <div style="display: flex; align-items: center; white-space: nowrap;">
                    ...
                    <span style="margin-left: 5px;">'.$destination.'</span>
                </div>
                <br><br>
                <div style="display: flex; align-items: center; white-space: nowrap;">
        ...
        <div class="section">
            ...
            <br>
            <div>
                <span class="label" style="margin-right: 10px;">CONFORME ROMANA:</span>
                <span style="display: inline-block; width: calc(100% - 150px); border-bottom: 1px solid black; vertical-align: middle;"></span>
            </div>
            </div>
        </div>
...
$html .= generateForm($data, $logoBase64, $exitHour, $nombre, $productos, $tara,  $destination, $observations);
