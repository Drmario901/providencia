 ...
 * Original file: /npm/simple-datatables@9.1.0/dist/umd/simple-datatables.js
 *
                        ...
                        (function () {
                                ...
                                return (
                                    "#text" === t.nodeName
                                        ...
                                        : (e
                                          ...
                                          s.valueDiffing &&
                                              (t.value &&
                                                  g(i, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") &&
                                                  (i.value = t.value),
                                              t.checked && g(i, "HTMLInputElement") && (i.checked = t.checked),
                                              t.selected && g(i, "HTMLOptionElement") && (i.selected = t.selected))),
                                    i
                                );
                            }
                            var v = function (t, e) {
                            ...
                            function w(t, e, s) {
                                var i,
                                    ...
                                    o = e[s._const.action],
                                    r = e[s._const.route];
                                [s._const.addElement, s._const.addTextElement].includes(o) || (i = v(t, r));
                                var l = { diff: e, node: i };
                                ...
                                switch (o) {
                                    ...
                                    case s._const.modifyAttribute:
                                        if (!i || !g(i, "Element")) return !1;
                                        i.setAttribute(e[s._const.name], e[s._const.newValue]), g(i, "HTMLInputElement") && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
                                        break;
                                    ...
                                    case s._const.modifyTextElement:
                                        ...
                                        s.textDiff(i, i.data, e[s._const.oldValue], e[s._const.newValue]), g(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.newValue]);
                                        break;
                                    ...
                                    case s._const.addElement:
                                        ...
                                        i.insertBefore(b(e[s._const.element], "http://www.w3.org/2000/svg" === i.namespaceURI, s), i.childNodes[c] || null);
                                        break;
                                    case s._const.removeTextElement:
                                        if (!i || 3 !== i.nodeType) return !1;
                                        var h = i.parentNode;
                                        h.removeChild(i), g(h, "HTMLTextAreaElement") && (h.value = "");
                                        break;
                                    case s._const.addTextElement:
                                        var u;
                                        if (((c = (u = r.slice()).splice(u.length - 1, 1)[0]), (n = s.document.createTextNode(e[s._const.value])), !(i = v(t, u)).childNodes)) return !1;
                                        i.insertBefore(n, i.childNodes[c] || null), g(i.parentNode, "HTMLTextAreaElement") && (i.parentNode.value = e[s._const.value]);
                                        break;
                                    default:
                            ...
                            var y = function (t) {
                                ...
                                x = function (t) {
                                    ...
                                    return (
                                        Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = p({}, t.attributes)),
                                                ...
                                                var t = (function (t, e, s, i) {
                                                    ...
                                                    for (var h = 0; h < o; h++)
                                                        for (var u = t[h], p = 0; p < r; p++) {
                                                            var m = e[p];
                                                            s[h] || i[p] || !E(u, m, d, c) ? (l[h + 1][p + 1] = 0) : ((l[h + 1][p + 1] = l[h][p] ? l[h][p] + 1 : 1), l[h + 1][p + 1] >= n && ((n = l[h + 1][p + 1]), (a = [h + 1, p + 1])));
                                                        }
                                        ...
                                        !(function (t, e, s) {
                                            ...
                                            switch (e[s._const.action]) {
                                                ...
                                                case s._const.addElement:
                                                    ...
                                                    (n = null === (i = S(t, d)) || void 0 === i ? void 0 : i.node),
                                                ...
                                                case s._const.addTextElement:
                                                    ...
                                                    (l = { nodeName: "#text", data: e[s._const.value] }),
                                                        (n = S(t, d).node).childNodes || (n.childNodes = []),
                                    ...
                                    g(t, "Text", "Comment")
                                        ...
                                        : (t.attributes &&
                                          ...
                                          e.valueDiffing &&
                                              ...
                                              g(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked
                                                  ? (s.checked = t.checked)
                                                  : g(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") &&
                                                    (s.value = t.value),
                                              g(t, "HTMLOptionElement") && (s.selected = t.selected))),
                                    s
                                );
                            }
                            ...
                            var R = { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, menuItem: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 },
                                H = function (t, e) {
                                        ...
                                        t.replace(A, function (r, l) {
                                            ...
                                            if (
                                                ...
                                                var b = -1 === n ? i : a[n].node.childNodes || [],
                                                    v = t.indexOf("<", h);
                                                (m = P(t.slice(h, -1 === v ? void 0 : v))), b.push({ nodeName: "#text", data: m });
                                            }
                                            return "";
                                        }),
                                        i[0]
                                ...
                                Y = (function () {
                                    function t(t, e, s) {
                                        (this.options = s),
                                            (this.t1 = "undefined" != typeof Element && g(t, "Element") ? T(t, this.options) : "string" == typeof t ? I(t, this.options) : JSON.parse(JSON.stringify(t))),
                                            (this.t2 = "undefined" != typeof Element && g(e, "Element") ? T(e, this.options) : "string" == typeof e ? I(e, this.options) : JSON.parse(JSON.stringify(e))),
                                            (this.diffcount = 0),
                                            (this.foundAll = !1),
                                            this.debug &&
                                                ((this.t1Orig = "undefined" != typeof Element && g(t, "Element") ? T(t, this.options) : "string" == typeof t ? I(t, this.options) : JSON.parse(JSON.stringify(t))),
                                                (this.t2Orig = "undefined" != typeof Element && g(e, "Element") ? T(e, this.options) : "string" == typeof e ? I(e, this.options) : JSON.parse(JSON.stringify(e)))),
                                            (this.tracker = new C());
                                    }
                                    return (
                                        ...
                                        (t.prototype.findDiffs = function (t, e) {
                                            ...
                                            do {
                                                ...
                                                0 === (s = this.findNextDiff(t, e, [])).length &&
                                                    (O(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : ((this.foundAll = !0), N(t), (s = this.findNextDiff(t, e, []))))),
                                                    s.length > 0 && ((this.foundAll = !1), this.tracker.add(s), k(t, s, this.options));
                                            } while (s.length > 0);
                                                    ...
                                                    (u && !p
                                                        ? "#text" === u.nodeName
                                                            ? (r.push(
                                                              ...
                                                              (l -= 1))
                                                            : (r.push(
                                                                  new m().setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(u))
                                                              ),
                                                              (l -= 1))
                                                        : p &&
                                                          !u &&
                                                          ("#text" === p.nodeName
                                                              ...
                                                              : r.push(
                                                                    new m().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, s.concat(l)).setValue(this.options._const.element, x(p))
                                                                ))),
                                                    u &&
                                                        p &&
                                                            ...
                                                            : O(u, p) ||
                                                              (i.length > n.length
                                                                  ...
                                                                  : (r = r.concat([
                                                                        new m()
                                                                            .setValue(this.options._const.action, this.options._const.replaceElement)
                                                                            .setValue(this.options._const.oldValue, x(u))
                                                                            .setValue(this.options._const.newValue, x(p))
                                                                            .setValue(this.options._const.route, s.concat(l)),
                                                                    ])))),
                                                    (l += 1);
                                            }
                                                    ...
                                                    if (!0 === h[w])
                                                        if ("#text" === (l = p[w]).nodeName)
                                                            if ("#text" === f[v].nodeName) {
                                                                if (l.data !== f[v].data) {
                                                                    for (var _ = w; p.length > _ + 1 && "#text" === p[_ + 1].nodeName; )
                                                                    ...
                                                                    d ||
                                                                        b.push(
                                                                            new m()
                                                                                .setValue(this.options._const.action, this.options._const.modifyTextElement)
                                                                                .setValue(this.options._const.route, i.concat(w))
                                                                                .setValue(this.options._const.oldValue, l.data)
                                                                                .setValue(this.options._const.newValue, f[v].data)
                                                                        );
                                                                }
                                                            } else
                                                                b.push(
                                                            ...
                                                            !0 === u[v]
                                                                ? b.push(
                                                                      new m()
                                                                          .setValue(this.options._const.action, this.options._const.replaceElement)
                                                                          .setValue(this.options._const.oldValue, x(l))
                                                                          .setValue(this.options._const.newValue, x(f[v]))
                                                                          .setValue(this.options._const.route, i.concat(w))
                                                                  )
                                                                : (b.push(
                                                                      new m()
                                                        ...
                                                        "#text" === (l = f[v]).nodeName
                                                            ? (b.push(
                                                                  new m().setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)
                                                              ),
                                                              h.splice(w, 0, !0),
                                                              p.splice(w, 0, { nodeName: "#text", data: l.data }),
                                                              (g = Math.min(h.length, u.length)))
                                                            : (b.push(
                                                                  new m().setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))
                                                              ),
                                                              h.splice(w, 0, !0),
                                                              p.splice(w, 0, x(l)),
                                                              (g = Math.min(h.length, u.length)));
                                                        ...
                                                        if (((r = s[h[w]]), (o = Math.min(r.newValue, p.length - r.length)) !== r.oldValue)) {
                                                            a = !1;
                                                ...
                                                (e = e.slice()).reverse(),
                                                    e.forEach(function (e) {
                                                        !(function (t, e, s) {
                                                            switch (e[s._const.action]) {
                                                                case s._const.addAttribute:
                                                                    (e[s._const.action] = s._const.removeAttribute), w(t, e, s);
                                                                    break;
                                                                case s._const.modifyAttribute:
                                                                    _(e, s._const.oldValue, s._const.newValue), w(t, e, s);
                                                                    break;
                                                                case s._const.removeAttribute:
                                                                    (e[s._const.action] = s._const.addAttribute), w(t, e, s);
                                                                    break;
                                                                case s._const.modifyTextElement:
                                                                case s._const.modifyValue:
                                                                case s._const.modifyComment:
                                                                ...
                                                                case s._const.relocateGroup:
                                                                    ...
                                                                    break;
                                                                case s._const.removeElement:
                                                                    (e[s._const.action] = s._const.addElement), w(t, e, s);
                                                                    break;
                                                                case s._const.addElement:
                                                                    (e[s._const.action] = s._const.removeElement), w(t, e, s);
                                                                    break;
                                                                case s._const.removeTextElement:
                                                                    (e[s._const.action] = s._const.addTextElement), w(t, e, s);
                                                                    break;
                                                                case s._const.addTextElement:
                                                                    (e[s._const.action] = s._const.removeTextElement), w(t, e, s);
                                                                    break;
                                                                default:
                                                                    console.log("unknown action");
                                                            }
                            ...
                            const F = (t, e, s, { classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l }, { noColumnWidths: d, unhideHeader: c }) => ({
                                    nodeName: "TR",
                                    childNodes: t
                                        .map((t, h) => {
                                            const p = e[h] || { type: l, format: n, sortable: !0, searchable: !0 };
                                            if (p.hidden) return;
                                            const f = t.attributes ? { ...t.attributes } : {};
                                            if (
                                                (p.sortable && o && (!r.length || c) && (p.filter ? (f["data-filterable"] = "true") : (f["data-sortable"] = "true")),
                                            ...
                                            return {
                                                nodeName: "TH",
                                                attributes: f,
                                                childNodes: (!a && !r.length) || c ? (p.sortable && o ? [{ nodeName: "BUTTON", attributes: { class: p.filter ? i.filter : i.sorter }, childNodes: m }] : m) : [{ nodeName: "#text", data: "" }],
                                            };
                                        })
                                        .filter((t) => t),
                                }),
                                B = (
                                    ...
                                    n,
                                    a,
                                    { classes: r, hiddenHeader: l, header: d, footer: c, format: h, sortable: p, scrollY: f, type: m, rowRender: g, tabIndex: b },
                                        ...
                                        childNodes: [
                                            {
                                                ...
                                                childNodes: s.map(({ row: t, index: e }) => {
                                                    const s = {
                                                        ...
                                                        childNodes: t.cells
                                                            .map((t, s) => {
                                                                const a = i[s] || { type: m, format: h, sortable: !0, searchable: !0 };
                                                                if (a.hidden) return;
                                                                const r = { nodeName: "TD", attributes: t.attributes ? { ...t.attributes } : {}, childNodes: "html" === a.type ? t.data : [{ nodeName: "#text", data: o(t) }] };
                                                                if (
                                                                    (d || c || !n.widths[s] || v || (r.attributes.style = u(r.attributes.style, `width: ${n.widths[s]}%;`)),
                                                                    a.cellClass && (r.attributes.class = u(r.attributes.class, a.cellClass)),
                                                                    a.render)
                                                                ) {
                                    ...
                                    if (((M.attributes.class = u(M.attributes.class, r.table)), d || c || _)) {
                                        const t = F(e, i, n, { classes: r, hiddenHeader: l, sortable: p, scrollY: f }, { noColumnWidths: v, unhideHeader: w });
                                        if (d || _) {
                                            const e = { nodeName: "THEAD", childNodes: [t] };
                                            (!f.length && !l) || w || (e.attributes = { style: "height: 0px;" }), M.childNodes.unshift(e);
                                        }
                                        if (c) {
                                            const e = { nodeName: "TFOOT", childNodes: [d ? structuredClone(t) : t] };
                                            (!f.length && !l) || w || (e.attributes = { style: "height: 0px;" }), M.childNodes.push(e);
                                        }
                                    }
                            ...
                            var U = z(
                                    ({ exports: {} }.exports = (function () {
                                        ...
                                        var x = (function () {
                                                function m(t) {
                                                    (this.$L = D(t.locale, null, !0)), this.parse(t), (this.$x = this.$x || t.x || {}), (this[_] = !0);
                                                }
                                                var g = m.prototype;
                                                return (
                                                    (g.parse = function (t) {
                            ...
                            const W = (t, e) => {
                                ...
                                Q = (t, e) => {
                                    ...
                                    switch (e.type) {
                                        ...
                                        case "number":
                                            ...
                                            break;
                                        case "html": {
                                            const t = Array.isArray(s.data) ? { nodeName: "TD", childNodes: s.data } : I(`<td>${String(s.data)}</td>`);
                                            s.data = t.childNodes || [];
                                            const e = a(t);
                                            (s.text = e), (s.order = e);
                                            break;
                                ...
                                Z = (t, e = void 0, s, i, n) => {
                                    ...
                                    if (t.headings) o.headings = t.headings.map((t) => X(t));
                                        ...
                                        o.headings = Array.from(e.tHead.querySelectorAll("th")).map((t, e) => {
                                            const o = ((t) => {
                                                ...
                                                let s;
                                                return (
                                                    (s = !e.childNodes || (1 === e.childNodes.length && "#text" === e.childNodes[0].nodeName) ? { data: t.innerText, type: "string" } : { data: e.childNodes, type: "html", text: a(e) }),
                                    ...
                                    for (let t = 0; t < o.headings.length; t++) s[t] || (s[t] = { type: i, format: n, sortable: !0, searchable: !0 });
                                    if (t.data) {
                                                    ...
                                                    const i = t.dataset.content
                                                        ...
                                                        : ((t, e) => {
                                                              ...
                                                              switch (e.type) {
                                                                  ...
                                                                  default:
                                                                      s = { data: T(t, { valueDiffing: !1 }).childNodes || [], text: t.innerText, order: t.innerText };
                                                              }
                            ...
                            class K {
                                ...
                                show(t) {
                                    Array.isArray(t) || (t = [t]),
                                        t.length &&
                                            (t.forEach((t) => {
                                                this.settings[t] || (this.settings[t] = { type: "string", sortable: !0 }), delete this.settings[t].hidden;
                                            }),
                                            this.dt.update());
                                }
                                visible(t) {
                                ...
                                add(t) {
                                    ...
                                    if (
                                        ((this.dt.data.headings = this.dt.data.headings.concat([X(t.heading)])),
                                ...
                                sort(t, e = void 0, s = !1) {
                                    ...
                                    this.dt.data.data.sort((s, i) => {
                                        ...
                                        return n && "number" != typeof l && "number" != typeof d ? n.compare(String(l), String(d)) : l < d ? -1 : l > d ? 1 : 0;
                                    }),
                            ...
                            const tt = {
                                    ...
                                    labels: {
                                        ...
                                        noResults: "No hay coincidencias con tu busqueda.",
                                        info: "Enseñando {start} hasta {end} de {rows} entradas",
                                    },
                                    template: (t, e) =>
                            ...
                            class it {
                                        ...
                                        this.options.contextMenu &&
                                            ...
                                            this.options.menuItems &&
                                                ...
                                                this.options.menuItems.forEach((t) => {
                                                    ...
                                                    if (!t.separator) {
                                                        const s = n("a", { class: this.options.classes.action, href: t.url || "#", html: "function" == typeof t.text ? t.text(this) : t.text });
                                                        e.appendChild(s),
                                                            t.action &&
                                ...
                                editCell(t) {
                                    ...
                                    (this.data = { cell: i, rowIndex: s, columnIndex: e, content: o(i) }), (this.editing = !0), (this.editingCell = !0), this.options.inline ? this.dt.update() : this.editCellModal(), this.closeMenu();
                                }
                                editCellModal() {
                                        ...
                                        a.addEventListener("click", (t) => {
                                            ...
                                            e instanceof Element &&
                                                (e.hasAttribute("data-editor-cancel")
                                                    ...
                                                    : e.hasAttribute("data-editor-save") && (t.preventDefault(), this.saveCell(d.value)));
                                        });
                                }
                                saveCell(t) {
                                        ...
                                        ? (this.editingCell
                                              ...
                                              : e.childNodes.forEach((s, i) => {
                                                    ...
                                                    this.options.excludeColumns.includes(n) ||
                                                        (e.childNodes[i].childNodes = [{ nodeName: "INPUT", attributes: { type: "text", value: r(a.text || String(a.data) || ""), class: this.options.classes.input } }]);
                                                }),
                                          e)
                                        : e;
                                }
                            ...
                            class at {
                                ...
                                init() {
                                    ...
                                    if (!e) {
                                        e = n("button", { class: this.options.classes.button, html: "▦" });
                            ...
                            (s.DataTable = class {
                                ...
                                constructor(t, e = {}) {
                                    ...
                                    (this.options = { ...tt, ...e, diffDomOptions: i, labels: n, classes: a }),
                                ...
                                _renderPagers() {
                                    ...
                                    let t = ((t, e, s, i, n) => {
                                        ...
                                        return n.firstLast && a.push(et(i, n.lastText, n)), { nodeName: "UL", attributes: { class: n.classes.paginationList }, childNodes: o.length > 1 ? a : [] };
                                ...
                                multiSearch(t) {
                                    ...
                                    if ((this.emit("datatable.multisearch:before", e, this._searchData), (this._searchQueries = e), !e.length))
                                        return this.update(), this.emit("datatable.multisearch", e, this._searchData), this.wrapperDOM.classList.remove("search-results"), !1;
                                    const s = e.map((t) =>
                                        this.columns.settings.map((e, s) => {
                                            ...
                                            return (
                                                ...
                                                (e.ignorePunctuation ?? this.options.ignorePunctuation) && (i = i.map((t) => t.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, ""))),
                                                i
                                            );
                                        })
                                    );
                                ...
                                page(t, e = !1) {
                                    return (
                                        ...
                                        t !== this._currentPage && (isNaN(t) || (this._currentPage = t), !(t > this.pages.length || t < 0) && (this._renderPage(e), this._renderPagers(), void this.emit("datatable.page", t)))
                                    );
                                }
                                insert(t) {
                                    let s = [];
                                    if (Array.isArray(t)) {
                                        const e = this.data.headings.map((t) => (t.data ? String(t.data) : t.text));
                                        t.forEach((t, i) => {
                                            const n = [];
                                            Object.entries(t).forEach(([t, s]) => {
                                                const a = e.indexOf(t);
                                                a > -1
                                                    ...
                                                    : this.hasHeadings || this.hasRows || 0 !== i || ((n[e.length] = Q(s, this.columns.settings[e.length])), e.push(t), this.data.headings.push(X(t)));
                                            }),
                                                s.push({ cells: n });
                                        });
                                    } else
                                        e(t) &&
                                            (!t.headings || this.hasHeadings || this.hasRows
                                                ? t.data &&
                                                  ...
                                                  (s = t.data.map((t) => {
                                                      let e, s;
                                                      return Array.isArray(t) ? ((e = {}), (s = t)) : ((e = t.attributes), (s = t.cells)), { attributes: e, cells: s.map((t, e) => Q(t, this.columns.settings[e])) };
                                                  }))
                                                : (this.data = Z(t, void 0, this.columns.settings, this.options.type, this.options.format)));
                                ...
                                setMessage(t) {
                                    ...
                                    if (
                                        ...
                                        (s.attributes.class = u(s.attributes.class, this.options.classes.table)),
                                ...
                                (s.exportSQL = function (t, s = {}) {
                                    ...
                                    let a = [];
                                    if (i.selection)
                                        if (Array.isArray(i.selection)) for (let e = 0; e < i.selection.length; e++) a = a.concat(t.pages[i.selection[e] - 1].map((t) => t.row));
                                        else a = t.pages[i.selection - 1].map((t) => t.row);
                                    else a = t.data.data;
                                    const r = a.map((t) => t.cells.filter((t, e) => n(e)).map((t) => o(t))),
                                        l = t.data.headings.filter((t, e) => n(e)).map((t) => t.text ?? String(t.data));
...
//# sourceMappingURL=/sm/e11965a8e60c006f5c237c00fe899cc65b93d0afc57fd99e208664d6acccd7fd.map
