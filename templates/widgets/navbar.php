  ...
  <div class="px-3 py-3 lg:px-5 lg:pl-3">
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center">
          ...
          <button type="button" data-dropdown-toggle="notification-dropdown" class="p-2 text-white bg-blue-900 border border-gray-300 rounded-lg hover:text-gray-900 hover:bg-white dark:text-white dark:bg-gray-800 dark:hover:bg-gray-700">
