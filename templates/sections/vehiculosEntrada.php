                                ...
                                <form id="entryForm" class="space-y-4">
                                    <div class="relative">
                                        ...
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                                <button type="button" class="focus:outline-none hover:text-blue-500" aria-label="Buscar por placa" id="searchPlateBtn">
                                                    <i data-lucide="truck" class="w-5 h-5"></i>
                                                </button>
                                            </span>
                                            <input type="text" name="plate" id="plate" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                        </div>
                                    </div>
                                    <div class="relative">
                                        ...
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                                <button type="button" class="focus:outline-none hover:text-blue-500" aria-label="Buscar por conductor" id="searchDriverBtn">
                                                    <i data-lucide="id-card" class="w-5 h-5"></i>
                                                </button>
                                            </span>
                                            <input type="text" name="driver" id="driver" class="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                                        </div>
                                    </div>
                                    <div class="relative">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="flex">
                                            ...
                                            <button type="button" class="inline-flex items-center px-3 text-sm font-medium text-white bg-blue-700 rounded-r-md border border-l-0 border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                                Leer peso
                                            </button>
                                        </div>
                                    </div>
