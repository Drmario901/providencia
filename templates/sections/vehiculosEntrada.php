                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-6 rounded-lg shadow">
                                <form id="entryForm" class="space-y-4">
                                    <div class="relative">
                                        ...
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                                <button data-tooltip-target="tooltip-plate" type="button" class="focus:outline-none hover:text-blue-500" aria-label="Buscar por placa" id="searchPlateBtn">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="flex">
                                            <span class="inline-flex items-center px-3 text-sm text-gray-900 bg-gray-200 border border-r-0 border-gray-300 rounded-l-md dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600">
                                                <button data-tooltip-target="tooltip-driver" type="button" class="focus:outline-none hover:text-blue-500" aria-label="Buscar por conductor" id="registerDriver">
                                                    <a data-lucide="id-card" class="w-5 h-5"></a>
                                                </button>
