...
<html lang="en" class="dark">
  <head>
    ...
    <?php
        ...
        require_js('vehiculos/salida.js');
        echo $favicon;
        echo $disable; 
    ?> 
  ...
  <body class="bg-gray-100">
    ...
    <div class="flex pt-16 overflow-hidden">
        ...
        <header class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-800">Registro de Salida de Vehículos</h1>
        </header>

        <form id="exitForm" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-6 group">
                    <label for="exitTime" class="block mb-2 text-sm font-medium text-gray-900">Hora de Salida</label>
                    <input type="datetime-local" id="exitTime" name="exitTime" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                </div>
                <div class="relative z-0 w-full mb-6 group">
                    <label for="observations" class="block mb-2 text-sm font-medium text-gray-900">Observaciones</label>
                    <textarea id="observations" name="observations" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                </div>
            </div>
            <button type="submit" class="text-white bg-blue-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Registrar Salida</button>
        </form>
    </div>
</div>
